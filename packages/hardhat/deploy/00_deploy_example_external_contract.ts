...
/**
 * Deploys a contract named "ExampleExternalContract" using the deployer account and
...
const deployExampleExternalContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  // const exampleExternalContract = await hre.ethers.getContract("ExampleExternalContract", deployer);
};
